...
const handleAnimalFormSubmit = event => {
  ...
  fetch('/api/animals', {
    //specifies what type of request this is. in this case it is a 'POST'
    method: 'POST',
    //tells the request what type of data we are looking to send then provide the data
    headers: {
      //tells the headers property to inform the request that it will be JSON data
      Accept: 'application/json',
      'Content-Type': 'application/json'
    },
    //add the stringified JSON data for animalObject to the body property
